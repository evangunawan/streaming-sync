...
class API {
  ...
  cookie = new Cookies();
  CLIENT_ID = '613891810766-g457r0sia00kssn3j8i9342v7a4rm28e.apps.googleusercontent.com';
  ...
  async getAccountInfo(){
    ...
    let userData;
    try{
      userData = await this.apiClient.reqGet('https://www.googleapis.com/youtube/v3/channels', 
      {
